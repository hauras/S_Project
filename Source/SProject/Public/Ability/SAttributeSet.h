 ...
 */
UCLASS()
class SPROJECT_API USAttributeSet : public UAttributeSet
{
	GENERATED_BODY()
public:
	USAttributeSet();
	...
	UPROPERTY(BlueprintReadOnly, ReplicatedUsing = OnRep_AttackPower, Category = "Vital Attributes")
	...
	UFUNCTION()
	void OnRep_MarkChance(const FGameplayAttributeData& OldMarkChance) const;
private:

	void SetEffectProperties(const FGameplayEffectModCallbackData& Data, FEffectProperties& Props) const;

	void ShowFloatingText(const FEffectProperties& Props, float Damage, bool bIsSynergy) const;
